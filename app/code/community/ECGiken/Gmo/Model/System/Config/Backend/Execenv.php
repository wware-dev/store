<?php
class ECGiken_Gmo_Model_System_Config_Backend_Execenv extends Mage_Adminhtml_Model_System_Config_Backend_File {
    protected function _beforeSave() {
        ...
        if(!empty($uploadFileName) && !is_array($uploadFileName)) {
            exec("cp ".$baseDir.$uploadDir.$uploadFileName." ".$baseDir.$moduleConfDir."connector.properties");
        }else{
